 ...
 */
export async function upsertUserTitleStatus(data) {
 ...
 */
export async function getUserLikedTitles(userId) {
    const supabase = useSupabaseClient();
    if (import.meta.dev) {
 ...
 */
export async function getUserLikedTitle(userId, tmdbId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .select('id')
 ...
 */
export async function getUserLikedStatuses(userId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .select('tmdb_id, type')
 ...
 */
export async function deleteUserTitleStatus(id) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .delete()
 ...
 */
export async function countUserLikedTitles(userId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
 ...
 */
export async function getUserSeenTitles(userId) {
    const supabase = useSupabaseClient();
    const result = await supabase
        .from(TABLES.USER_TITLE_STATUS)
 ...
 */
export async function getUserNotInterestedTitles(userId) {
    const supabase = useSupabaseClient();
    const result = await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .select('id, tmdb_id, type')
 ...
 */
export async function getUserWatchlistTitles(userId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .select('id, tmdb_id, type')
 ...
 */
export async function removeNotInterested(userId, tmdbId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
        .delete()
 ...
 */
export async function removeLike(userId, tmdbId) {
    const supabase = useSupabaseClient();
 ...
 */
export async function getTitleStatus(userId, tmdbId) {
    const supabase = useSupabaseClient();
    return await supabase
        .from(TABLES.USER_TITLE_STATUS)
