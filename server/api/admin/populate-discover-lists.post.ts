    ...
    titles: [
      ...
      },
      {
        ...
        tag: {
          ...
          gl: 'comedia clásica',
          en: 'classic comedy',
          'en-gb': 'classic comedy',
        },
      },
      {
        name: 'Parks and Recreation',
        tag: {
          es: 'comedia optimista',
          ca: 'comèdia optimista',
          eu: 'komedia optimista',
          gl: 'comedia optimista',
          en: 'optimistic comedy',
          'en-gb': 'optimistic comedy',
        },
      },
      {
      ...
      },
      {
        ...
        tag: {
          ...
          ca: 'comèdia romàntica',
          eu: 'komedia erromantikoa',
          gl: 'comedia romántica',
          en: 'romantic comedy',
          'en-gb': 'romantic comedy',
        },
      },
      {
        name: 'The Good Place',
        tag: {
          es: 'comedia inteligente',
          ca: 'comèdia intel·ligent',
          eu: 'komedia adimentsua',
          gl: 'comedia intelixente',
          en: 'smart comedy',
          'en-gb': 'smart comedy',
        },
      },
  ...
  },
  {
    ...
    titles: [
      ...
      },
      {
        ...
        tag: {
          es: 'primer episodio impactante',
          ca: 'primer episodi impactant',
          eu: 'lehen atala hunkigarria',
          gl: 'primeiro episodio impactante',
          en: 'impactful first episode',
          'en-gb': 'impactful first episode',
        },
      },
      {
        name: 'Stranger Things',
        tag: {
          es: 'primer episodio adictivo',
          ca: 'primer episodi addictiu',
          eu: 'lehen atala adikzioa',
          gl: 'primeiro episodio adictivo',
          en: 'addictive first episode',
          'en-gb': 'addictive first episode',
        },
      },
      {
        name: 'The Last of Us',
        tag: {
          es: 'primer episodio emocional',
          ca: 'primer episodi emocional',
          eu: 'lehen atala emozionala',
          gl: 'primeiro episodio emocional',
          en: 'emotional first episode',
          'en-gb': 'emotional first episode',
        },
      },
      {
        name: 'True Detective',
        tag: {
          es: 'primer episodio atmosférico',
          ca: 'primer episodi atmosfèric',
          eu: 'lehen atala atmosferikoa',
          gl: 'primeiro episodio atmosférico',
          en: 'atmospheric first episode',
          'en-gb': 'atmospheric first episode',
        },
      },
      {
        name: 'The Haunting of Hill House',
        tag: {
          es: 'primer episodio inquietante',
          ca: 'primer episodi inquietant',
          eu: 'lehen atala kezkagarria',
          gl: 'primeiro episodio inquietante',
          en: 'unsettling first episode',
          'en-gb': 'unsettling first episode',
        },
      },
      {
        name: 'Prison Break',
        tag: {
          es: 'primer episodio intenso',
          ca: 'primer episodi intens',
          eu: 'lehen atala intentsua',
          gl: 'primeiro episodio intenso',
          en: 'intense first episode',
          'en-gb': 'intense first episode',
        },
      },
      {
        name: 'Sherlock',
        tag: {
          es: 'primer episodio brillante',
          ca: 'primer episodi brillant',
          eu: 'lehen atala distiratsua',
          gl: 'primeiro episodio brillante',
          en: 'brilliant first episode',
          'en-gb': 'brilliant first episode',
        },
      },
      {
        name: '24',
        tag: {
          es: 'formato en tiempo real',
          ca: 'format en temps real',
          eu: 'denbora errealean formatua',
          gl: 'formato en tempo real',
          en: 'real-time format',
          'en-gb': 'real-time format',
        },
      },
      {
        name: 'Orphan Black',
        tag: {
          es: 'primer episodio sorprendente',
          ca: 'primer episodi sorprenent',
          eu: 'lehen atala harrigarria',
          gl: 'primeiro episodio sorprendente',
          en: 'surprising first episode',
          'en-gb': 'surprising first episode',
        },
      },
    ],
  },
  ...
  },
  {
    ...
    titles: [
      ...
      },
      {
        name: 'The Crown',
        tag: {
          es: 'narrativa absorbente',
          ca: 'narrativa absorbent',
          eu: 'narratiba xurgatzailea',
          gl: 'narrativa absorbente',
          en: 'absorbing narrative',
          'en-gb': 'absorbing narrative',
        },
      },
      {
  ...
  },
  {
    ...
    titles: [
      ...
      },
      {
        ...
        tag: {
          es: 'giro sorprendente',
          ca: 'gir sorprenent',
          eu: 'bira harrigarria',
          gl: 'xiro sorprendente',
          en: 'surprising twist',
          'en-gb': 'surprising twist',
        },
      },
      {
        name: 'Fight Club',
        tag: {
          es: 'giro memorable',
          ca: 'gir memorable',
          eu: 'bira gogoangarria',
          gl: 'xiro memorable',
          en: 'memorable twist',
          'en-gb': 'memorable twist',
        },
      },
      {
        name: 'The Prestige',
      ...
      },
      {
        ...
        tag: {
          es: 'giro psicológico',
          ca: 'gir psicològic',
          eu: 'bira psikologikoa',
          gl: 'xiro psicolóxico',
          en: 'psychological twist',
          'en-gb': 'psychological twist',
        },
      },
      {
        name: 'Gone Girl',
      ...
      },
      {
        ...
        tag: {
          es: 'giro estructural',
          ca: 'gir estructural',
          eu: 'bira estrukturala',
          gl: 'xiro estrutural',
          en: 'structural twist',
          'en-gb': 'structural twist',
        },
      },
      {
        name: 'The Others',
      ...
      },
      {
        ...
        tag: {
          es: 'giro conceptual',
          ca: 'gir conceptual',
          eu: 'bira kontzeptuala',
          gl: 'xiro conceptual',
          en: 'conceptual twist',
          'en-gb': 'conceptual twist',
        },
      },
    ],
  },
    ...
    titles: [
      {
        name: 'Lost',
        tag: {
          es: 'primer episodio icónico',
          ca: 'primer episodi icònic',
          eu: 'lehen atala ikonikoa',
          gl: 'primeiro episodio icónico',
          en: 'iconic first episode',
          'en-gb': 'iconic first episode',
        },
      },
      {
        name: 'The Boys',
      ...
      },
      {
        name: 'Westworld',
        tag: {
          es: 'primer episodio fascinante',
          ca: 'primer episodi fascinant',
          eu: 'lehen atala liluragarria',
          gl: 'primeiro episodio fascinante',
          en: 'fascinating first episode',
          'en-gb': 'fascinating first episode',
        },
      },
      {
      ...
      },
      {
        name: 'Killing Eve',
        tag: {
          es: 'primer episodio intrigante',
          ca: 'primer episodi intrigant',
          eu: 'lehen atala intrigagarria',
          gl: 'primeiro episodio intrigante',
          en: 'intriguing first episode',
          'en-gb': 'intriguing first episode',
        },
      },
      {
        name: 'The Leftovers',
        tag: {
          es: 'primer episodio misterioso',
          ca: 'primer episodi misteriós',
          eu: 'lehen atala misteriotsua',
          gl: 'primeiro episodio misterioso',
          en: 'mysterious first episode',
          'en-gb': 'mysterious first episode',
        },
      },
      {
        name: 'Black Mirror',
      ...
      },
      {
        ...
        tag: {
          es: 'primer episodio épico',
          ca: 'primer episodi èpic',
          eu: 'lehen atala epikoa',
          gl: 'primeiro episodio épico',
          en: 'epic first episode',
          'en-gb': 'epic first episode',
        },
      },
      {
        name: 'Squid Game',
    ...
    titles: [
      ...
      },
      {
        ...
        tag: {
          es: 'acción y música',
          ca: 'acció i música',
          eu: 'ekintza eta musika',
          gl: 'acción e música',
          en: 'action and music',
          'en-gb': 'action and music',
        },
      },
      {
        name: 'Kingsman: The Secret Service',
        tag: {
          es: 'acción estilizada',
          ca: 'acció estilitzada',
          eu: 'ekintza estilizatua',
          gl: 'acción estilizada',
          en: 'stylized action',
          'en-gb': 'stylized action',
        },
      },
      {
        name: 'Deadpool',
        tag: {
          es: 'acción y humor',
          ca: 'acció i humor',
          eu: 'ekintza eta umorea',
          gl: 'acción e humor',
          en: 'action and humor',
          'en-gb': 'action and humour',
        },
      },
      {
        name: 'Kick-Ass',
        tag: {
          es: 'acción irreverente',
          ca: 'acció irreverent',
          eu: 'ekintza errespetugabea',
          gl: 'acción irreverente',
          en: 'irreverent action',
          'en-gb': 'irreverent action',
        },
      },
      {
        name: 'The Raid',
        tag: {
          es: 'acción sin respiro',
          ca: 'acció sense respir',
          eu: 'ekintza arnasarik gabe',
          gl: 'acción sen respiro',
          en: 'non-stop action',
          'en-gb': 'non-stop action',
        },
      },
      {
        name: 'Skyfall',
...
async function searchTitleInTMDB(
  ...
  try {
    ...
    if (!response.results || response.results.length === 0) {
      ...
      logWarn('[PopulateDiscover] No results found', {
        titleName,
      });
      return null;
    }
    ...
    if (filteredResults.length === 0) {
      const { logWarn } = await import('@/server/utils/logger');
      logWarn('[PopulateDiscover] No results found for expected type', {
        titleName,
        expectedType,
      });
      return null;
...
async function ensureTitleInDatabase(
  ...
  if (checkError) {
    const { logError } = await import('@/server/utils/logger');
    logError('[PopulateDiscover] Error checking title', checkError as Error, {
      tmdbId,
      type,
    });
    return false;
  ...
  try {
    ...
    if (Object.keys(titleMultiLang).length > 0) {
      ...
      if (insertError) {
        const { logError } = await import('@/server/utils/logger');
        logError(
          '[PopulateDiscover] Error inserting title',
    ...
    const { logError } = await import('@/server/utils/logger');
    logError(
      '[PopulateDiscover] Error fetching title from TMDB',
      error as Error,
      {
        tmdbId,
        type,
...
async function insertTitleIntoList(
  ...
  if (checkError) {
    const { logError } = await import('@/server/utils/logger');
    logError(
      '[PopulateDiscover] Error checking list item',
      checkError as Error,
      {
        discoverListId,
        tmdbId,
  ...
  if (existingItem) {
    ...
    if (updateError) {
      const { logError } = await import('@/server/utils/logger');
      logError(
        '[PopulateDiscover] Error updating list item',
  ...
  if (insertError) {
    const { logError } = await import('@/server/utils/logger');
    logError(
      '[PopulateDiscover] Error inserting list item',
      insertError as Error,
      {
        discoverListId,
        tmdbId,
...
export default defineEventHandler(async () => {
  try {
    ...
    for (const listData of DISCOVER_LISTS) {
      ...
      if (!slug) {
        const { logWarn } = await import('@/server/utils/logger');
        logWarn('[PopulateDiscover] No slug found for list', {
      ...
      if (listError || !discoverList) {
        const { logError } = await import('@/server/utils/logger');
        logError('[PopulateDiscover] Error fetching list', listError as Error, {
          slug,
        });
        results.push({
          listName: listData.name,
      ...
      if (deleteError) {
        const { logError } = await import('@/server/utils/logger');
        logError(
          '[PopulateDiscover] Error deleting existing items for list',
          deleteError as Error,
          {
            slug,
            discoverListId: discoverList.id,
          }
        );
      ...
      for (let position = 0; position < listData.titles.length; position++) {
        ...
        try {
          ...
          if (!searchResult) {
            listResult.errors.push(`Title not found in TMDB: ${titleName}`);
            continue;
          }
