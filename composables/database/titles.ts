...
export async function getTitlesByTmdbIds(
  ...
  const result = await supabase
    .from(TABLES.TITLES)
    .select(
      `${TITLES_COLUMNS.ID}, ${TITLES_COLUMNS.TITLE}, ${TITLES_COLUMNS.TYPE}, ${TITLES_COLUMNS.POSTER_PATH}, ${TITLES_COLUMNS.TMDB_ID}, ${TITLES_COLUMNS.OVERVIEW}, ${TITLES_COLUMNS.VOTE_AVERAGE}, ${TITLES_COLUMNS.TAGLINE}, ${TITLES_COLUMNS.GENRES}`
    )
